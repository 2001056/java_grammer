...
//    특정 변수에 NotEmpty 어노테이션 설정이 있을 경우, 값이 비어있는지 검사하는 메서드
    static void validate(Object object) throws IllegalAccessException{
//        리플렉션 기술을 통해 런타임 시점에 private 변수라 할지라도 객체 안의 필드값을 꺼내 확인할 수 있음.
...
// 아래 NetEmpty 어노테이션 클래스는 어떤 기능도 없지만, 특정 필드값이 비어있으면 안된다는 선언적 표시.
