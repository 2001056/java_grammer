...
//        참조 자료형 : 기본자료형을 제외한 클래스 기반의 객체
//        특징 : new 키워드를 통해 값 세팅
//        String st1 = "hello world"; // 정석 아님
...
//        << 배열은toString 메서드가 별도로 구현 되어 있기때문에 , 별도로 호출 해 줘야 함
...
//        참조자료형은 스택메모리에 힙메모리 주소값이 저장되므로, ==로 비교시 메모리 주소값 비교
...
////        오토박싱 : 원시자료형 -> Wrapper클래스 자동 형 변환
//        Integer ig1 = i1;
////        오토언박싱 : Wrapper클래스 -> 원시자료형 자동 형 변환
//        int i2 = ig1;
