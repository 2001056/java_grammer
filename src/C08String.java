...
//        리터럴 방식 : String pool 을 사용하는 방식 (java추천)
...
//        문자열 더하기 : +=사용, 성능 측면에서는 추후 배율 StringBuffer, StringBuilder를 사용

//        String st1 = "hello";
//        st1 += " world";
//        st1 += "1"; //String에 char를 더하면 자동으로 String 변환
//        System.out.println(st1);

//        프로그래머스 - 플랫폼 사용법 (나머지구하기)
...
////        숫자제거
//        String answer6 = st1.replaceAll("[0-9]","");
...
//
//        }
//        sb.insert(0,"C++"); //문자열 중간에 insert하는 것은 성능 저하를 발생.
//        sb.deleteCharAt(sb.length()-1);//마지막 index를 삭제하는 것 외에는 성능 저하 발생.
//        result = sb.toString();
//        System.out.println(result);

//        StringBuilder는 성능이 뛰어나지만, 동시성 문제있음(Thread-Safe하지않음)
//        예를 들어) 쓰레드A가 append("hello") 쓰레드B가 append("world")
//        이 두작업이 중간에 섞여 "heworldllo" 이런식으로 잘못된값을 만들수 있음
