...
//    변수의 유효 범위 : 클래스변수와 객체변수는 클래스 전역에서 사용 가능
...
//        지녁변수 : 지역변수는 해당 메서드내에서만 사용
    ...
    public static void scope1(int v3){//call by value : 값을 통한 호출. 값만을 전달했다.
        v3=30;
        System.out.println(v3);//30
    }
    public static void scope2(C04Person person){ // call by reference : 참조의 의한 호출. 힙메모리 주소값 전달.
        person.setName("lee");
        System.out.println(person.returnPersonInfo());
    }
}
