...
////       위코드는 요소(속성)들이 그룹화되어 있찌 않다보니, 중복과 코드의 가독성이 저하

////       클래스에 속성을 정의하여, 사람 객체로 생성 하겠다.
...
//        p2.name = "hong2";
//        p2.email = "hong2naver.com";
//        p2.age = 40;
//        printMember(p1.name,p1.email,p1.age);
//        printMember2(p1);
//        printMember2(p2);
////        위코드의 문제점
////        1.person객체의 변수에 외부 클래스에서 접근가능
////        2.person에 대한 출력 코드가 외부클래스마다 중복되어 들어갈 여지
...
//        System.out.println("이름은 "+ person.name; +" 이메일은 " + person.email +" 나이는 "+ person.age+" 입니다"); //// private로 바꾼 뒤로 사용 불가.
